...
@Entity
@Table(name = "content_package_imports", schema = "scripture")
public class ContentPackageImportJpaEntity {
    ...
    protected ContentPackageImportJpaEntity() {
    }
    ...
    public String getAttemptedPackageId() {
        return attemptedPackageId;
    }

    public void setAttemptedPackageId(String attemptedPackageId) {
        this.attemptedPackageId = attemptedPackageId;
    }
    ...
    public ImportExecutionStatus getImportStatus() {
        return importStatus;
    }

    public void setImportStatus(ImportExecutionStatus importStatus) {
    ...
    public int getRecordsValidated() {
        return recordsValidated;
    }

    public void setRecordsValidated(int recordsValidated) {
    ...
    public ImportFailureCode getFailureCode() {
        return failureCode;
    }

    public void setFailureCode(ImportFailureCode failureCode) {
