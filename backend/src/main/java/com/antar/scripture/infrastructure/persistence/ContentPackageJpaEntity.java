...
@Entity
@Table(name = "content_packages", schema = "scripture")
public class ContentPackageJpaEntity {
    ...
    @Column(name = "verses_checksum", nullable = false, length = 64)
    private String versesChecksum;
    ...
    protected ContentPackageJpaEntity() {
    }
    ...
    public void setPackageFormatVersion(int packageFormatVersion) {
        this.packageFormatVersion = packageFormatVersion;
    }

    public String getScriptureId() {
        return scriptureId;
    }

    public void setScriptureId(String scriptureId) {
    ...
    public ContentPackageStatus getPackageStatus() {
        return packageStatus;
    }

    public void setPackageStatus(ContentPackageStatus packageStatus) {
    ...
    public String getProvenanceChecksum() {
        return provenanceChecksum;
    }

    public void setProvenanceChecksum(String provenanceChecksum) {
        this.provenanceChecksum = provenanceChecksum;
    }

    public String getVersesChecksum() {
        return versesChecksum;
    }

    public void setVersesChecksum(String versesChecksum) {
        this.versesChecksum = versesChecksum;
    }

    public List<String> getSourceRegistryReferences() {
        return sourceRegistryReferences;
    }

    public void setSourceRegistryReferences(List<String> sourceRegistryReferences) {
        this.sourceRegistryReferences = sourceRegistryReferences;
    }

    public int getImporterVersion() {
        return importerVersion;
    }

    public void setImporterVersion(int importerVersion) {
    ...
    public void setFirstImportedAt(Instant firstImportedAt) {
