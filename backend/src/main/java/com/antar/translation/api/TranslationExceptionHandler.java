...
import com.antar.translation.application.query.TranslationNotFoundException;
import com.antar.translation.domain.InvalidVerseIdException;
...
public class TranslationExceptionHandler {
    ...
    public ResponseEntity<ProblemDetailsResponse> handleNotFound(
            TranslationNotFoundException exception, HttpServletRequest request) {
        return problem(
